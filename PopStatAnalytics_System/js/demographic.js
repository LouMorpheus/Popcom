...
function openViewModal(
    ...
    document.getElementById(
        "view_female_death"
    ).innerText = femaleDeath;

    document.getElementById(
        "view_birth_on_date_male"
    ).innerText = onDateMale;

    document.getElementById(
        "view_birth_on_date_female"
    ).innerText = onDateFemale;

    document.getElementById(
        "view_birth_late_male"
    ).innerText = lateMale;

    document.getElementById(
        "view_birth_late_female"
    ).innerText = lateFemale;
    ...
    document.getElementById(
        "view_not_married"
    ).innerText = notMarried;

    document.getElementById(
        "view_adolescent"
    ).innerText = adolescent;
